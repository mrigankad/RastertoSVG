...
class BatchTemplateService:
                    ...
                    "steps": [
                        {
                            "name": "denoise",
                            "enabled": True,
                            "params": {"method": "bilateral", "strength": "light"},
                        },
                    ...
                    "steps": [
                        {
                            "name": "denoise",
                            "enabled": True,
                            "params": {"method": "nlm", "strength": "medium"},
                        },
                    ...
                    "steps": [
                        {
                            "name": "denoise",
                            "enabled": True,
                            "params": {"method": "nlm", "strength": "heavy"},
                        },
                        {"name": "sharpen", "enabled": True, "params": {"amount": 1.5}},
                        {
                            "name": "contrast",
                            "enabled": True,
                            "params": {"method": "clahe", "clip_limit": 3},
                        },
                    ]
                },
                output_config={
    ...
    def _filter_files(
        ...
        if template.max_file_size:
            filtered = [
                f for f in filtered if f.exists() and f.stat().st_size <= template.max_file_size
            ]
