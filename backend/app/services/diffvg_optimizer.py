...
class SVGPathOptimizer:
    ...
    def optimize_svg(
        ...
        try:
            ...
            if enable_gradients:
                result, n_gradients = self._detect_and_add_gradients(
    ...
    def _quantize_colors(
        self, svg_content: str, tolerance: int = 8
    ) -> Tuple[str, int]:
    ...
    def _create_linear_gradient(
        self, grad_id: str, grad: Dict[str, Any]
    ) -> str:
